 ...
 *
 *********************************************************/
#define AW8624_I2C_ADDR (0x5A)
#define AW862XX_I2C_ADDR (0x58)

#define AW_RST_GPIO_Port GPIOG
#define AW_RST_Pin GPIO_PIN_6
/*********************************************************
 *
 * Marco
 *
...
#define AW_RAMDATA_RD_BUFFER_SIZE (60)
#define AW_RAMDATA_WR_BUFFER_SIZE (60)
...
struct haptic_nv
{
	...
	aw_bool is_supported_rtp;
	aw_bool is_supported_trig;
...
extern int haptic_nv_read_chipid(uint8_t *, uint8_t);
...
extern struct haptic_nv haptic_nv;
...
extern struct aw_haptic_dts_info aw8624_dts;
extern uint8_t aw8624_ram_data[];
extern uint32_t aw8624_ram_len;
#endif
...
extern struct aw_haptic_func aw862xx_func_list;
extern struct aw_haptic_dts_info aw86214_dts;
#endif
...
#if defined(AW86214_DRIVER) || defined(AW8622X_DRIVER) || defined(AW8623X_DRIVER)
